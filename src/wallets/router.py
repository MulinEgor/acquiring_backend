...
async def create_wallet(
    ...
    _=Depends(dependencies.check_user_permissions([PermissionEnum.CREATE_WALLET])),
...
async def get_wallet_by_address_route(
    address: str,
    _=Depends(dependencies.check_user_permissions([PermissionEnum.GET_WALLET])),
    session: AsyncSession = Depends(dependencies.get_session),
):
    """
...
async def delete_wallet_by_address_route(
    address: str,
    _=Depends(dependencies.check_user_permissions([PermissionEnum.DELETE_WALLET])),
    session: AsyncSession = Depends(dependencies.get_session),
):
    """
