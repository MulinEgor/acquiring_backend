...
Revision ID: 7dfefdb5a288
Revises:
Create Date: 2025-03-23 13:40:37.124414+00:00
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "CONFIRMED", "FAILED", name="transactionstatusenum"),
            nullable=False,
        ),
