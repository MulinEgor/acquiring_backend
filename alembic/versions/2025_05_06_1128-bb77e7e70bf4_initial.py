...
Revision ID: bb77e7e70bf4
Revises:
Create Date: 2025-05-06 11:28:29.887256+00:00
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("type", sa.Enum("PUSH", "SMS", name="regextype"), nullable=False),
        sa.Column("created_at", sa.TIMESTAMP(timezone=True), nullable=False),
        sa.Column("updated_at", sa.TIMESTAMP(timezone=True), nullable=False),
        sa.PrimaryKeyConstraint("id", name=op.f("regex_pkey")),
        sa.UniqueConstraint("sender", name=op.f("regex_sender_key")),
    )
    op.create_table(
        "users",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
